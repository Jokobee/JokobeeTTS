...
// :kokoro-french-voice-marine — discoverability alias, zero code. Depends entirely
// on kokoro-french-voice-female (the real content) so it stays in lockstep with no
// duplicated maintenance. Published as: com.jokobee:kokoro-french-voice-marine.
android {
    namespace = "com.jokobee.tts.voice.marine.alias2"
    compileSdk = 36
...
mavenPublishing {
    coordinates("com.jokobee", "kokoro-french-voice-marine", "1.0.0")
