...
// :tts-android-ai — second discoverability alias, zero code. Depends entirely
// on jokobeetts (the real engine) so it stays in lockstep with no duplicated
// maintenance. Published as: com.jokobee:tts-android-ai.
android {
    namespace = "com.jokobee.tts.alias2"
    compileSdk = 36
...
mavenPublishing {
    coordinates("com.jokobee", "tts-android-ai", "1.1.0")
    ...
    pom {
        name.set("TTS Android AI (JokobeeTTS)")
